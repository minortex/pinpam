    ...
    in
    {
      ...
      nixosModules.default =
        ...
        let
          ...
          mkMasterKeyService = _service: serviceCfg:
            let
              denyAnchorOrder = cfg.masterKey.fallbackDenyOrder;
              ...
              postRuleOrderMap =
                lib.listToAttrs (
                  lib.imap0 (
                    index: ruleName:
                    lib.nameValuePair ruleName (masterKeyOrder + 1 + index)
                  ) presentPostRules
                );
              ...
              postRuleOrderOverrides =
                lib.mapAttrs (ruleName: order: {
                  order = lib.mkForce order;
                }) postRuleOrderMap;
                  ...
                  lib.types.submodule {
                    options = {
                      ...
                      successRules = lib.mkOption {
                        ...
                        description = ''
                          Existing auth rules that should route successful authentication into
                          the master-key stage.
                        '';
                      };
